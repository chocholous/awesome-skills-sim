...
| [`apify-sim-alpha`](skills/apify-sim-alpha/SKILL.md) | Simulation skill Alpha. Validates the parallel-merge scenario of the generated-marketplace architecture — two concurrent skill PRs must merge without touching .claude-plugin/marketplace.json. Not a real skill; safe to delete. | [sim-harness](https://github.com/chocholous/awesome-skills-sim) |
